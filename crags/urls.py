...
urlpatterns = [
    ...
    path('crag/<int:pk_crag>/route/<int:pk>/', views.IndexRouteView.as_view(), name='route_index'),
    ...
    path('crag/<int:pk_crag>/route/<int:pk_route>/anecdoteForm/', views.add_anecdote_view, name='anecdote_create'),
]
